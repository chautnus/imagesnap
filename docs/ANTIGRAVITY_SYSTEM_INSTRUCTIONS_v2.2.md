...
[6]  /review L2           → AGENT-REVIEW-A + B xuất review_report
[7]  Human quyết định     → ghi decision_record
[8]  /rtm-update          → cập nhật RTM.md
[9]  /sync                → cập nhật ANTIGRAVITY.md + DEVLOG entry đầy đủ
```
...
│      → /implement plan.md → /review L2                           │
│      → human decision_record → /rtm-update → /sync              │
│                                                                   │
...
├───────────────────────────────────────────────────────────────────┤
│  Schemas (§5):  boot · plan · review · decision · sync            │
...
│  Agent owns: logic · security · traceability · doc completeness  │
└───────────────────────────────────────────────────────────────────┘
```

---

*Owner: Engineering Lead · v2.2 · 2025-Q2*
