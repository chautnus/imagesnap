...
|-------|-------------|----------|-------|-------|------|--------------|-----------|--------|
| BR-1.1 | Data Storage | ARCH-2.3 | `src/shared/lib/sheets.ts`, `src/shared/lib/drive.ts` | N/A | High | 2026-04-27 | Passed | Active |
| BR-1.1.3 | Naming Conv | ARCH-2.3 | `src/shared/services/productService.ts` | N/A | Low | 2026-04-27 | Passed | Active |
| BR-1.2 | Performance (Img Quality) | ARCH-2.2 | `src/extension/content_script.js` | N/A | Low | 2026-04-27 | Passed | Active |
| BR-1.2.1 | Thumbnail Optimize | ARCH-2.3 | `src/web/components/DataTab.tsx` | N/A | Low | 2026-04-27 | Passed | Active |
...
| BR-3.1 | Extension | ARCH-2.2 | `src/extension/*`, `src/shared/services/dataService.ts` | N/A | Med | 2026-04-27 | Passed | Active |
| BR-3.2 | Camera | ARCH-2.4 | `src/web/components/CaptureTab.tsx` | N/A | Low | 2026-04-27 | Passed | Active |
