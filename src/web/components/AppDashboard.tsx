...
interface AppDashboardProps {
  ...
  handleUpdateProduct?: (product: Partial<any>) => Promise<void>;
...
export const AppDashboard: React.FC<AppDashboardProps> = ({
  ...
  lang, t, toggleLang,
  handleSaveProduct, handleUpdateProduct, handleDeleteProduct, handleSaveCategory, handleDeleteCategory,
  onLogout,
}) => {
      ...
      <main className="min-h-[calc(100vh-240px)] overflow-y-auto">
        ...
        {activeTab === 'data' && (
          <DataTab
            ...
            onUpdate={handleUpdateProduct || (async () => {})}
            t={t}
            lang={lang}
            subStatus={subStatus}
          />
