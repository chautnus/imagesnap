...
const posts = [
  ...
  { title: "How to Build a Swipe File in Google Drive (That You'll Actually Use)", slug: "swipe-file-google-drive", description: "Most swipe files die within a week. Here's the Google Drive + Sheets setup that keeps yours organized, searchable, and actually useful.", date: "June 10, 2026", readTime: "7 min read" },
  { title: "How to Track Competitors in Google Sheets (Without a $500/mo Tool)", slug: "competitor-research-google-sheets", description: "You don't need Crayon or Klue. Here's the exact Google Sheets setup e-commerce teams use to track pricing, products, and visual positioning.", date: "June 12, 2026", readTime: "8 min read" },
  { title: "The Product Research Workflow That Scales (Without a Scraper)", slug: "product-research-workflow", description: "Scrapers break. Manual copy-paste doesn't scale. Here's the middle path: human-guided capture that handles 200+ products per session.", date: "June 14, 2026", readTime: "6 min read" }
];
