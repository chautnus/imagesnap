        ...
        <div className="space-y-16">
          <section>
            ...
            <p className="text-muted text-lg mb-8 leading-relaxed font-medium">
              ...
              When you actually need the inspiration â€” for a campaign brief or a pitch deck â€” you can't find it.
            </p>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-white/5">
                  <tr>
                    ...
                    <td className="py-4 px-4 text-red-400">âŒ</td>
                  ...
                  <tr>
                    ...
                    <td className="py-4 px-4">âœ… (Manual)</td>
                    <td className="py-4 px-4">âœ…</td>
                    <td className="py-4 px-4">Semi</td>
                  </tr>
                  <tr className="bg-accent/5">
                    <td className="py-4 px-4 font-bold">ImageSnap</td>
                    <td className="py-4 px-4 font-bold text-accent">âœ… (Auto-fill)</td>
                    <td className="py-4 px-4 font-bold text-accent">âœ… (Sheets)</td>
                    <td className="py-4 px-4 font-bold text-accent">âœ… (Native)</td>
                  </tr>
                </tbody>
              </table>
            </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                   ...
                   <ul className="space-y-2 text-muted font-medium text-sm">
                      <li>â€¢ <strong>Brand</strong> â€” who made this?</li>
                      <li>â€¢ <strong>Channel</strong> â€” ad, email, landing page?</li>
                      <li>â€¢ <strong>Technique</strong> â€” social proof, urgency, UGC?</li>
                      <li>â€¢ <strong>Rating</strong> â€” how good is the execution?</li>
                      <li>â€¢ <strong>Notes</strong> â€” why did you save it?</li>
                   </ul>
                </div>
                <div className="space-y-4">
          ...
          <section id="faq" className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                { q: "Can I capture ads from social media?", a: "Yes. If you can see it in your browser, you can capture it. Facebook ads, Instagram, Twitter â€” images save to Drive, context to Sheets." },
